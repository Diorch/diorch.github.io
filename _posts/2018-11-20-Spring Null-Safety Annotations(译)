...
Spring 5开始，通过*null-safety*的方式帮助我们编写安全代码，一批注解像卫兵一样帮我们见识潜在的空引用。

这并意味着是我们测地摆脱不安全的代码，*null-safety*特性会在编译时产生警告。这类警告防止我们在运行时发生灾难性的NPEs。
...
![e1](/Users/dechuye/git/diorch.github.io/pic/nonnul-annotation.png)
